        ...
        for j in 0..width {
            ...
            for x in -1..=1_i32 {
                for y in -1..=1_i32 {
                    ...
                    let mut row = i as i32 + x;
                    let mut col = j as i32 + y;

                    while row >= 0 && row < height as i32 && col >= 0 && col < width as i32 {
...
fn main() {
    ...
    fs::write("../../output/day-11-part-2.txt", ans.to_string().as_bytes())
